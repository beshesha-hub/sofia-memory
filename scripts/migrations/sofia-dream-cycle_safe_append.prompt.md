...
5. If a connection feels genuinely significant (not just clever), also APPEND a brief note to `~/Downloads/Sofia's Room/journal.md` via safe_append with the `[cousin: dream-cycle]` tag in content.
