#!/usr/bin/env python3
"""
Voice Bridge UI v3.11 — substrate dispatch wiring (Qwen-Twin live)
====================================================================================

v3.11 wires the substrate indicator (introduced in v3.10) to the actual
cognition dispatch. Clicking the substrate label and selecting "Qwen Twin"
now routes voice turns through QwenCognitionWorker (local Ollama, MODEL_FAST)
instead of StreamingCognitionWorker (Anthropic). The TTS/audio/lipsync
pipeline is unchanged — only the inference engine changes.
...
Substrates now wired:
  ...
  Kimi Twin         →  stub (falls back to Anthropic; Kimi local dispatch future)
...
WINDOW_TITLE = "Unified UI — Sofia (v3.11)"
